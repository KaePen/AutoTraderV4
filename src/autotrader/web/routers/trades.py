...
from autotrader.web.schemas import ApiResponse, TradeResponse, TradeSummaryResponse
...
async def get_trades(
    ...
    symbol: str | None = Query(default=None, description="通貨ペア"),
...
@router.get("/trades/summary", response_model=ApiResponse[TradeSummaryResponse])
