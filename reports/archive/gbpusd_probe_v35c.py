"""GBPUSD v3.5c プロービング: ATR1.1最適化深掘り

ATR1.1閾値を軸に、SL/TP・ADX・フィルター組み合わせを微調整。

操作方法:
    cd /d/Projects/AutoTraderV4/tmp/feat_gbpusd-opt-v3
    python reports/gbpusd_probe_v35c.py --workers 9
"""
...
def build_probe_grid():
    ...
    return [
        ...
        ("A11 SL3/TP1.5", OptimizeConfig(
            ...
            atr_expansion_threshold=ATR, volume=1.0,
        )),
        ("A11 SL3.5/TP1.5", OptimizeConfig(
            min_signals=3, adx_threshold=22,
            rsi_oversold=33, rsi_overbought=67,
        ...
        # --- ATR1.1 + ADX厳格 ---
        ("A11 ADX25 SL3/TP1.5", OptimizeConfig(
        ...
        ("A11 ADX30 SL3/TP1.5", OptimizeConfig(
            min_signals=3, adx_threshold=30,
            rsi_oversold=33, rsi_overbought=67,
            sl_atr_mult=3.0, tp_atr_mult=1.5,
            cooldown_bars=4, mtf_bonus=2,
            require_trend_align=TA,
        ...
        ("A11 ADX25 SL3.5/TP1.5", OptimizeConfig(
            min_signals=3, adx_threshold=25,
            rsi_oversold=33, rsi_overbought=67,
            sl_atr_mult=3.5, tp_atr_mult=1.5,
            cooldown_bars=4, mtf_bonus=2,
        ...
        # --- ATR1.1 + DI方向 ---
        ("A11 DI SL3/TP1.5", OptimizeConfig(
            min_signals=3, adx_threshold=22,
            rsi_oversold=33, rsi_overbought=67,
            sl_atr_mult=3.0, tp_atr_mult=1.5,
            cooldown_bars=4, mtf_bonus=2,
        ...
        ("A11 DI SL3.5/TP1.5", OptimizeConfig(
            min_signals=3, adx_threshold=22,
            rsi_oversold=33, rsi_overbought=67,
            sl_atr_mult=3.5, tp_atr_mult=1.5,
            cooldown_bars=4, mtf_bonus=2,
        ...
        # --- ATR1.1 + min_signals高め ---
        ("A11 min4 SL3/TP1.5", OptimizeConfig(
        ...
        ("A11 min4 SL3.5/TP1.5", OptimizeConfig(
            min_signals=4, adx_threshold=22,
            rsi_oversold=30, rsi_overbought=70,
            sl_atr_mult=3.5, tp_atr_mult=1.5,
            cooldown_bars=4, mtf_bonus=3,
        ...
        ("A105 SL3/TP1.5", OptimizeConfig(
            ...
            require_trend_align=TA,
            atr_expansion_filter=True,
            atr_expansion_threshold=1.05, volume=1.0,
        )),
        ("A105 SL3.5/TP1.5", OptimizeConfig(
            min_signals=3, adx_threshold=22,
            rsi_oversold=33, rsi_overbought=67,
            sl_atr_mult=3.5, tp_atr_mult=1.5,
            cooldown_bars=4, mtf_bonus=2,
        ...
        # --- ATR1.1 + 複合フィルター最良候補 ---
        ("A11 DI ADX25 SL3.5/TP1.5", OptimizeConfig(
            min_signals=3, adx_threshold=25,
            rsi_oversold=33, rsi_overbought=67,
            sl_atr_mult=3.5, tp_atr_mult=1.5,
            cooldown_bars=4, mtf_bonus=2,
        ...
        ("A11 min4 DI SL3.5/TP1.5", OptimizeConfig(
            min_signals=4, adx_threshold=22,
            rsi_oversold=30, rsi_overbought=70,
            sl_atr_mult=3.5, tp_atr_mult=1.5,
            cooldown_bars=4, mtf_bonus=3,
...
def main() -> None:
    ...
    for r, i in enumerate(ranked, 1):
        ...
        lbl = labels[i]
        gap = abs(tr["pf"] - vr["pf"])
        consistency = "OK" if gap < 0.15 else "!!"
        print(
            f"#{r:2d} {lbl:<30}"
